...
function commandsText(source)
	...
	TriggerClientEvent("chatMessage", source, "", {0, 0, 0}, "2) ^3/me <msg>^0 - talks as yourself doing an action")
	TriggerClientEvent("chatMessage", source, "", {0, 0, 0}, "3) ^3/ooc <msg>^0 - use this out of character")
	TriggerClientEvent("chatMessage", source, "", {0, 0, 0}, "4) ^3/911 <msg>^0 - call 911, make sure to report a location and description")
	TriggerClientEvent("chatMessage", source, "", {0, 0, 0}, "5) ^3/ad <msg>^0 - create an advertisement")
	TriggerClientEvent("chatMessage", source, "", {0, 0, 0}, "6) ^3/text <id> <msg>^0 - send private message to someone")
	TriggerClientEvent("chatMessage", source, "", {0, 0, 0}, "7) ^3/emote^0 to see more emotes")
	TriggerClientEvent("chatMessage", source, "", {0, 0, 0}, "8) ^3/rules^0 to see the server rules")
end
