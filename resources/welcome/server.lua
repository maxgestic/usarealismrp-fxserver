...
TriggerEvent('es:addCommand', 'jobs', function(source, args, user)
	...
	TriggerClientEvent("chatMessage", source, "", {0, 0, 0}, "4) Bank Tobbery")
	...
	TriggerClientEvent("chatMessage", source, "", {0, 0, 0}, "11) Police, EMS and Delta PMC is whitelisted - apply for it on the website")
end)
...
TriggerEvent('es:addCommand', 'job', function(source, args, user)
	...
	TriggerClientEvent("chatMessage", source, "", {0, 0, 0}, "9) Create/sell methamphetamines")
	TriggerClientEvent("chatMessage", source, "", {0, 0, 0}, "10) Anything else you can RP with :)")
	TriggerClientEvent("chatMessage", source, "", {0, 0, 0}, "11) Police, EMS and PMC is whitelisted - apply for it on the website")
end)
