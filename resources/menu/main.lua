...
RegisterNetEvent("universal:menuOpen")
AddEventHandler("universal:menuOpen", function()
	send("toggle")
end)

RegisterNetEvent("universal:menuClose")
AddEventHandler("universal:menuClose", function()
	menuopen = false
	SendNUIMessage({
		hidemenu = true
	})
