...
local banks = {
  ...
  {name="Bank", id = 108, x = 1175.9, y = 2706.8, z = 38.1},
  {name="Bank", id = 108, x = 236.9, y = 217.4, z = 106.3}
}
    ...
    while true do
      ...
      if(IsNearBank() or IsNearATM()) then
        if (atBank == false) then
          TriggerEvent('es_rp:notify', "Press INPUT_CONTEXT (~r~default E~w~) to access bank")
        end
        atBank = true
