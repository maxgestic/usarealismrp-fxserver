-- TODO:
-- 1) add voice sounds when picking up and dropping off NPCs
-- 2) give random chance for NPC to be playing scenario when spawned in
...
function spawnVehicle(name)
    ...
    Citizen.CreateThread(function()
        ...
        JOB.taxi = CreateVehicle(numberHash, spawn.x, spawn.y, spawn.z, 0.0, true, false)
