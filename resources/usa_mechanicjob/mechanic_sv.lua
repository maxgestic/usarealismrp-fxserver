...
local PARTS_FOR_RANK = {
	[1] = {},
	[2] = {"NOS Install Kit", "NOS Bottle (Stage 1)", "NOS Bottle (Stage 2)", "Top Speed Tune", "NOS Gauge", "Custom Radio", "Low Grip Tires", "Normal Tires", "RGB Controller", "Underglow Kit", "Xenon Headlights", "Stage 1 Brakes", "5% Window Tint", "20% Window Tint", "35% Window Tint", "Tint Remover", "Stage 1 Transmission", "Turbo"},
	[3] = {"NOS Install Kit", "NOS Bottle (Stage 1)", "NOS Bottle (Stage 2)", "NOS Bottle (Stage 3)", "Top Speed Tune", "NOS Gauge", "Custom Radio", "Manual Conversion Kit", "Auto Conversion Kit", "RGB Controller", "Low Grip Tires", "Normal Tires", "Underglow Kit", "Xenon Headlights", "Stage 1 Brakes", "Stage 2 Brakes", "5% Window Tint", "20% Window Tint", "35% Window Tint", "Tint Remover", "Stage 1 Transmission", "Stage 2 Transmission", "Turbo", "20% Armor"}
}
