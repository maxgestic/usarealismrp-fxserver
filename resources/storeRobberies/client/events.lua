        ...
        elseif(Config.Framework == "VRP")then --Only runs if you are using VRP
            if(vRPCheck)then
                if(Config.UsingSurveillanceSystem)then
                    ...
                    TriggerEvent('chatMessage', '[911]', 'your-code-here', 'Store Robbery in progress at ' .. Config.Shops[store].name ..  ' (CCTV: ' .. CCTV .. ')')
                else
                    TriggerEvent('chatMessage', '[911]', 'your-code-here', 'Store Robbery in progress at ' .. Config.Shops[store].name ..  '.')
                end
