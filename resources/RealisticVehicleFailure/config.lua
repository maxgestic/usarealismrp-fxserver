...
cfg = {
	...
	damageFactorPetrolTank = 34.0,				-- Sane values are 1 to 200. Higher values means more damage to vehicle. A good starting point is 64
	...
	degradingFailureThreshold = 720.0,			-- Below this value, slow health degradation will set in
	...
	randomTireBurstInterval = 2400,				-- Number of minutes (statistically, not precisely) to drive above 22 mph before you get a tire puncture. 0=feature is disabled
