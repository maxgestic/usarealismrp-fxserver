storeItems = {
    ...
    {name = "Arizona Iced Tea", price = 1, type = "drink", substance = 20.0, quantity = 1, legality = "legal", weight = 1},
    {name = "Coffee", price = 4, type = "drink", substance = 15.0, quantity = 1, legality = "legal", weight = 2},
    {name = "Slurpee", price = 4, type = "drink", substance = 22.0, quantity = 1, legality = "legal", weight = 2},
    {name = "Yoohoo Chocolate Drink", price = 3, type = "drink", substance = 10.0, quantity = 1, legality = "legal", weight = 1},
