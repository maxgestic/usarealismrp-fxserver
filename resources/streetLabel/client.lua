			...
			if(zones[GetNameOfZone(pos.x, pos.y, pos.z)] and tostring(GetStreetNameFromHashKey(var1)))then
				...
				elseif direction == 'SE' then
					...
					if tostring(GetStreetNameFromHashKey(var2)) == "" then
						...
						drawTxt2(x-0.275, x+0.435, 1.0,1.0,0.45, tostring(GetStreetNameFromHashKey(var2)) .. ", " .. zones[GetNameOfZone(pos.x, pos.y, pos.z)], str_around_r, str_around_g, str_around_b, str_around_a)
					end
