...
local markets = {
  ...
  ['marketC'] = {
    ...
    ['items'] = {
      ...
      { name = "Tommy Gun Parts", price = tonumber(tostring(math.random(40, 75)) .. "000"), type = "weaponParts", weight = 45.0, quantity = 1, stock = math.random(0, 2) },
      ...
      { name = "AK-47 Parts", price = tonumber(tostring(math.random(45, 100)) .. "000"), type = "weaponParts", weight = 45.0, quantity = 1, stock = math.random(0, 2) },
      ...
      { name = "Carbine Parts", price = tonumber(tostring(math.random(45, 100)) .. "000"), type = "weaponParts", weight = 45.0, quantity = 1, stock = math.random(0, 2) },
      ...
      { name = "Compact Rifle Parts", price = tonumber(tostring(math.random(45, 80)) .. "000"), type = "weaponParts", weight = 40.0, quantity = 1, stock = math.random(0, 2) },
      { name = "Military Rifle Parts", price = tonumber(tostring(math.random(50, 100)) .. "000"), type = "weaponParts", weight = 35.0, quantity = 1, stock = math.random(0, 2) },
