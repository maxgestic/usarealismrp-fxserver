...
local markets = {
  ['marketA'] = {
    ...
    ['items'] = {
      ...
      { name = "AP Pistol Parts", price = tonumber(tostring(math.random(20, 50)) .. "000"), type = "weaponParts", weight = 15.0, quantity = 1, stock = math.random(0, 2) },
      ...
      { name = "Micro SMG Parts", price = tonumber(tostring(math.random(30, 50)) .. "000"), type = "weaponParts", weight = 30.0, quantity = 1, stock = math.random(0, 2) },
  ...
  ['marketC'] = {
    ...
    ['items'] = {
      ...
      { name = "Tommy Gun Parts", price = tonumber(tostring(math.random(50, 75)) .. "000"), type = "weaponParts", weight = 45.0, quantity = 1, stock = math.random(0, 2) },
      ...
      { name = "AK-47 Parts", price = tonumber(tostring(math.random(70, 120)) .. "000"), type = "weaponParts", weight = 45.0, quantity = 1, stock = math.random(0, 2) },
      ...
      { name = "Carbine Parts", price = tonumber(tostring(math.random(90, 150)) .. "000"), type = "weaponParts", weight = 45.0, quantity = 1, stock = math.random(0, 2) },
      ...
      { name = "Compact Rifle Parts", price = tonumber(tostring(math.random(60, 90)) .. "000"), type = "weaponParts", weight = 40.0, quantity = 1, stock = math.random(0, 2) },
      { name = "Military Rifle Parts", price = tonumber(tostring(math.random(100, 150)) .. "000"), type = "weaponParts", weight = 35.0, quantity = 1, stock = math.random(0, 2) },
