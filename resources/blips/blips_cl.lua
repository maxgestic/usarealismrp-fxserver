local blips = {
	...
	{ title="Black Market Dealer", colour = 49, id = 150, x = 129.345, y = -1920.89, z = 20.0187 },
	{ title="General Store", colour = 25 , id = 357, x=1729.59, y=6415.49, z=34.0 },
	{ title="General Store", colour = 25 , id = 357, x=81.6779, y=-219.006, z=54.6367 },
	{ title="Sheriff's Office", colour = 38 , id = 60, x=451.255, y=-992.41, z=30.6896 },
	{ title="Hospital", colour = 59, id = 60, x=360.31, y=-590.445, z=28.6563 },
