...
RegisterNetEvent("chickenJob:notify")
AddEventHandler("chickenJob:notify", function(message)
	SetNotificationTextEntry("STRING")
	SetNotificationMessage("CHAR_PROPERTY_CAR_SCRAP_YARD", "CHAR_PROPERTY_CAR_SCRAP_YARD", true, 1, "Cluckin' Bell", message)
