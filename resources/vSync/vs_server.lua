...
TriggerEvent('es:addGroupCommand', 'weather', "admin", function(source, args, user)
	...
	params = {
		{ name = "type", help = "XTRASUNNY, CLEAR, NEUTRAL, SMOG, FOGGY, OVERCAST, CLOUDS, CLEARING, RAIN, THUNDER, SNOW, BLIZZARD, SNOWLIGHT, XMAS, HALLOWEEN" }
	}
})
...
TriggerEvent('es:addGroupCommand', 'time', "admin", function(source, args, user)
	...
	params = {
		{ name = "hour", help = "00-24" },
		{ name = "minute", help = "00-59" }
	}
})
