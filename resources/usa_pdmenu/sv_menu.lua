local LEO_VEHICLES = {"pdcvpi", "pdtau", "pdchrg", "pdchgr", "pdexp", "pdtahoe", "pdchrgum", "riot", "policeb", "fbi", "fbi2", "police4", "sheriff2", "1200RT", "chgr", "sotruck", "pdcharger", "pdfpiu", "hptahoe", "mustang19"}
