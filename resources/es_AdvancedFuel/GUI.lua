...
RegisterNetEvent("fuelGUI:Title")
AddEventHandler("fuelGUI:Title", function(title)
	Menu.Title(title)
end)

RegisterNetEvent("fuelGUI:Option")
AddEventHandler("fuelGUI:Option", function(option, cb)
	cb(Menu.Option(option))
end)

RegisterNetEvent("fuelGUI:Bool")
AddEventHandler("fuelGUI:Bool", function(option, bool, cb)
	Menu.Bool(option, bool, function(data)
		cb(data)
	end)
end)

RegisterNetEvent("fuelGUI:Int")
AddEventHandler("fuelGUI:Int", function(option, int, min, max, cb)
	Menu.Int(option, int, min, max, function(data)
		cb(data)
	end)
end)

RegisterNetEvent("fuelGUI:StringArray")
AddEventHandler("fuelGUI:StringArray", function(option, array, position, cb)
	Menu.StringArray(option, array, position, function(data)
		cb(data)
	end)
end)

RegisterNetEvent("fuelGUI:Update")
AddEventHandler("fuelGUI:Update", function()
