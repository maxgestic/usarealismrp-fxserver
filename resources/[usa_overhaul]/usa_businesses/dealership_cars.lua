vehicleShopItems = {
	...
	["Coupes"] = {
		...
		{make = "Enus", model = "Cognoscenti Carbio", price = 89643, hash = 330661258, storage_capacity = 135.0},
	...
	["Muscles"] = {
		{make = "Willand", model = "Faction", price = 13750, hash = -2119578145, storage_capacity = 160.0},
	...
	["Sedans"] = {
		...
		{make = "Vulcan", model = "Ingot", price = 13876, hash = -1289722222, storage_capacity = 165.0},
		...
		{make = "Vulcan", model = "Warrener", price = 14846, hash = 1373123368, storage_capacity = 165.0},
