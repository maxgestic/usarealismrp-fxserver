...
Citizen.CreateThread(function()
  while true do
    ...
    DrawText3D(2224.04, 5577.28, 53.7, 10, '[E] - Harvest Weed')
    DrawText3D(1036.35, -3203.71, -38.17, 10, '[E] - Process Weed')
    DrawText3D(1546.81, 2166.45, 78.72, 3, '[E] - Enter')
    DrawText3D(1066.40, -3183.47, -39.16, 3, '[E] - Exit')
    if IsControlJustPressed(1, KEY) then
      ...
      elseif Vdist(playerCoords, 1036.35, -3203.71, -38.17) < 3.5 and not processed then
