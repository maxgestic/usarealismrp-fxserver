...
local GENERAL_STORE_ITEMS = {
  ["Food"] = {
    {name = "Tuna Sandwich", price = 3, type = "food", substance = 30.0, quantity = 1, legality = "legal", weight = 10, objectModel = "prop_sandwich_01"},
    {name = "Chocolate Pizza", price = 10, type = "food", substance = 25.0, quantity = 1, legality = "legal", weight = 6, objectModel = "ng_proc_food_chips01a"},
    {name = "Cheeseburger", price = 6, type = "food", substance = 30.0, quantity = 1, legality = "legal", weight = 10, objectModel = "prop_cs_burger_01"},
    {name = "Kosher Hot Dog", price = 3, type = "food", substance = 35.0, quantity = 1, legality = "legal", weight = 10, objectModel = "prop_cs_hotdog_01"},
    {name = "Microwave Burrito", price = 2, type = "food", substance = 30.0, quantity = 1, legality = "legal", weight = 10, objectModel = "prop_food_bs_burger2"},
    ...
    {name = "Donut", price = 8, type = "food", substance = 5.0, quantity = 6, legality = "legal", weight = 7, objectModel = "prop_donut_01"},
    {name = "Taco", price = 2, type = "food", substance = 10.0, quantity = 1, legality = "legal", weight = 10, objectModel = "prop_taco_01"},
    {name = "Nachos", price = 3, type = "food", substance = 12.0, quantity = 1, legality = "legal", weight = 11, objectModel = "ng_proc_food_chips01b"},
    {name = "Walkers Milk Chocolate Toffee", price = 8, type = "food", substance = 15.0, quantity = 1, legality = "legal", weight = 5, objectModel = "ng_proc_food_chips01a"},
    ...
    {name = "Doritos", price = 3, type = "food", substance = 6.0, quantity = 1, legality = "legal", weight = 7, objectModel = "ng_proc_food_chips01b"},
    {name = "Curly Fries", price = 5, type = "food", substance = 12.0, quantity = 1, legality = "legal", weight = 10, objectModel = "prop_food_chips"}
  },
  ["Drinks"] = {
    {name = "Water", price = 3, type = "drink", substance = 60.0, quantity = 1, legality = "legal", weight = 10, objectModel = "ba_prop_club_water_bottle"},
    {name = "Arizona Iced Tea", price = 1, type = "drink", substance = 60.0, quantity = 1, legality = "legal", weight = 10, objectModel = "ba_prop_club_water_bottle"},
    {name = "Gatorade", price = 4, type = "drink", substance = 70.0, quantity = 1, legality = "legal", weight = 10, objectModel = "prop_energy_drink"},
    {name = "Caramel Iced Coffee", price = 2, type = "drink", substance = 20.0, quantity = 1, legality = "legal", weight = 10, objectModel = "prop_food_coffee"},
    {name = "Mocha Iced Coffee", price = 2, type = "drink", substance = 20.0, quantity = 1, legality = "legal", weight = 10, objectModel = "prop_food_coffee"},
    {name = "Slurpee", price = 4, type = "drink", substance = 22.0, quantity = 1, legality = "legal", weight = 15, objectModel = "prop_food_juice01"},
    {name = "Pepsi", price = 4, type = "drink", substance = 9.0, quantity = 1, legality = "legal", weight = 10, objectModel = "ng_proc_sodacan_01b"},
    {name = "Dr. Pepper", price = 3, type = "drink", substance = 8.0, quantity = 1, legality = "legal", weight = 10, objectModel = "ng_proc_sodacan_01b"},
    {name = "Grape Soda", price = 2, type = "drink", substance = 8.0, quantity = 1, legality = "legal", weight = 10, objectModel = "ng_proc_sodacan_01b"},
    {name = "Monster Energy Drink", price = 6, type = "drink", substance = 22.0, quantity = 1, legality = "legal", weight = 10, objectModel = "prop_energy_drink", blockedInPrison = true},
    {name = "Four Loko (8%)", price = 8, type = "alcohol", substance = 6.0, quantity = 1, legality = "legal", weight = 10, strength = 0.04, objectModel = "prop_energy_drink", blockedInPrison = true},
    {name = "Corona Light Beer (4%)", price = 6, type = "alcohol", substance = 8.0, quantity = 4, legality = "legal", weight = 10, strength = 0.03, objectModel = "prop_beer_bottle", blockedInPrison = true},
    {name = "Jack Daniels Whiskey (40%)", price = 20, type = "alcohol", substance = 10.0, quantity = 1, legality = "legal", weight = 12, strength = 0.08, objectModel = "prop_whiskey_bottle", blockedInPrison = true},
    {name = "Champagne (12.5%)", price = 40, type = "alcohol", substance = 18.0, quantity = 1, legality = "legal", weight = 10, strength = 0.06, objectModel = "prop_whiskey_bottle", blockedInPrison = true},
    {name = "Everclear Vodka (90%)", price = 35, type = "alcohol", substance = 5.0, quantity = 1, legality = "legal", weight = 10, strength = 0.10, objectModel = "prop_vodka_bottle", blockedInPrison = true}
  },
  ["Electronics"] = {
    { name = "Cell Phone", price = 650, type = "misc", quantity = 1, legality = "legal", contacts = {}, conversations = {}, weight = 10, objectModel = "prop_npc_phone_02", blockedInPrison = true}
  },
  ["Misc"] = {
