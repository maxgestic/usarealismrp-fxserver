...
local DOORS = {
  ...
  --{name = "SSPD / Cell 1", x = 1848.6, y = 3708.2, z = 1.06, model = -642608865, locked = false, _dist = 1.5, allowedJobs = {'sheriff', 'corrections', 'judge'}},
  --{name = "SSPD / Cell 2", x = 1847.6, y = 3709.9, z = 1.05, model = -642608865, locked = false, _dist = 1.5, allowedJobs = {'sheriff', 'corrections', 'judge'}},
  --{name = "SSPD / Cell 3", x = 1844.8, y = 3705.2, z = 1.06, model = -642608865, locked = false, _dist = 1.5, allowedJobs = {'sheriff', 'corrections', 'judge'}},
  --{name = "SSPD / Cell 4", x = 1843.5, y = 3707.0, z = 1.06, model = -642608865, locked = false, _dist = 1.5, allowedJobs = {'sheriff', 'corrections', 'judge'}},
  ...
  {name = 'Hospital / Door 1', x = 328.3, y = -585.03, z = 43.3, model = -770740285, locked = false, offset={0.0, 1.02, 0.05}, heading = 160, _dist = 1.5, allowedJobs = {'ems', 'sheriff', 'doctor', "corrections"}},
  {name = 'Hospital / Door 2', x = 331.1, y = -586.03, z = 43.3, model = -770740285, locked = false, offset={0.0, 1.02, 0.05}, heading = 340, _dist = 1.5, allowedJobs = {'ems', 'sheriff', 'doctor', "corrections"}},
  ...
  {name = 'Mission Row / Door 3', x = 465.26, y = -988.99, z = 24.91, model = -131296141, locked = true, static = true, _dist = 1.5, allowedJobs = {'sheriff', "ems", "corrections", "judge"}},
  {name = 'Mission Row / Door 4', x = 465.54, y = -990.56, z = 24.91, model = -131296141, locked = false, offset={0.0, 1.22, 0.025}, heading = 270, _dist = 1.5, allowedJobs = {'sheriff', "ems", "corrections", "judge"}},
  {name = 'Mission Row / Interview Room', x = 468.00, y = -992.85, z = 24.91, model = -131296141, locked = true, offset={0.0, 1.22, 0.025}, heading = 0, _dist = 1.5, allowedJobs = {'sheriff', "ems", "corrections", "judge"}},
  {name = 'Mission Row / Interview Door', x = 470.36, y = -994.47, z = 24.91, model = -131296141, locked = true, offset={0.0, 1.22, 0.025}, heading = 90, _dist = 1.5, allowedJobs = {'sheriff', "ems", "corrections", "judge"}},
  {name = 'Mission Row / Photo Door', x = 470.22, y = -987.20, z = 24.91, model = -131296141, locked = true, offset={0.0, 1.22, 0.025}, heading = 180, _dist = 1.5, allowedJobs = {'sheriff', "ems", "corrections", "judge"}},
  {name = 'Mission Row / Interview Door 2', x = 477.70, y = -987.27, z = 24.91, model = -131296141, locked = true, offset={0.0, 1.22, 0.025}, heading = 359, _dist = 1.5, allowedJobs = {'sheriff', "ems", "corrections", "judge"}},
