        ...
        <section class="grid-container">
            <div v-for="race in races" class="race w3-card">
                ...
                <div style="height: 70px; align-content: center;">
                    ...
                    <p class="race-description" v-if="race.participants.length > 0"><span v-for="participant in race.participants">({{participant.source}}) {{participant.name}},</span></p>
                    <p class="race-description" v-else><small>Be the first to join!</small></p>
                </div>
