TokoVoipConfig = {
	...
	keyProximity = 289, -- Keybind used to switch the proximity mode (F2)
	...
	plugin_data = {
		...
		TSChannelWait = "SERVER_WAITING",
		
		-- Blocking screen informations
		TSServer = "185.181.11.220", -- TeamSpeak server address to be displayed on blocking screen
		TSChannelSupport = "SEVRER_SUPPORT", -- TeamSpeak support channel name displayed on blocking screen
