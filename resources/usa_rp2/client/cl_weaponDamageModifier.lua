...
local WEAPON_DAMAGE_MODIFIERS = {
  ...
  [`WEAPON_MICROSMG`] = 1.3,
  [`WEAPON_SMG`] = 1.35,
  [`WEAPON_COMBATPDW`] = 1.45,
  [`WEAPON_ASSAULTSMG`] = 1.45,
  [`WEAPON_MINISMG`] = 1.4,
  [`WEAPON_SMG_MK2`] = 1.5,
  [`WEAPON_GUSENBERG`] = 1.3,
  [`WEAPON_COMPACTRIFLE`] = 1.5,
  [`WEAPON_ASSAULTRIFLE`] = 1.6,
  [`WEAPON_ASSAULTRIFLE_MK2`] = 1.65,
  [`WEAPON_CARBINERIFLE`] = 1.75,
  [`WEAPON_CARBINERIFLE_MK2`] = 1.8,
