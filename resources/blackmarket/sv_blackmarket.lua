local sv_storeItems = {
    ["weapons"] = {
		    { name = "Lock Pick", type = "misc", hash = 615608432, price = 1000, legality = "illegal", quantity = 1, weight = 5, stock = math.random(10, 25)},
        { name = "Molotov", type = "weapon", hash = 615608432, price = 650, legality = "illegal", quantity = 1, weight = 20, stock = math.random(10, 25)},
        { name = "Brass Knuckles", type = "weapon", hash = -656458692, price = 650, legality = "illegal", quantity = 1, weight = 5, stock = math.random(5, 15)},
        { name = "Dagger", type = "weapon", hash = -1834847097, price = 1250, legality = "illegal", quantity = 1, weight = 10, stock = math.random(5, 15) },
        { name = "Switchblade", type = "weapon", hash = -538741184, price = 5000, legality = "illegal", quantity = 1, weight = 10, stock = math.random(5, 15) },
        { name = "AP Pistol", type = "weapon", hash = 0x22D8FE39, price = 38550, legality = "illegal", quantity = 1, weight = 15, stock = math.random(6, 15) },
        { name = "Sawn-off", type = "weapon", hash = 0x7846A318, price = 25000, legality = "illegal", quantity = 1, weight = 30, stock = math.random(4, 15) },
        { name = "Micro SMG", type = "weapon", hash = 324215364, price = 50000, legality = "illegal", quantity = 1, weight = 30, stock = math.random(3, 9) },
        { name = "SMG", type = "weapon", hash = 736523883, price = 50700, legality = "illegal", quantity = 1, weight = 45, stock = math.random(3, 9) },
        { name = "Machine Pistol", type = "weapon", hash = -619010992, price = 45500, legality = "illegal", quantity = 1, weight = 20, stock = math.random(3, 9) },
        { name = "Tommy Gun", type = "weapon", hash = 1627465347, price = 95750, legality = "illegal", quantity = 1, weight = 45, stock = math.random(1, 6) },
        { name = "AK47", type = "weapon", hash = -1074790547, price = 120500, legality = "illegal", quantity = 1, weight = 45, stock = math.random(1, 5) },
        { name = "Carbine", type = "weapon", hash = -2084633992, price = 120500, legality = "illegal", quantity = 1, weight = 45, stock = math.random(1, 5) },
        ...
        { name = "Bullpup Rifle", type = "weapon", hash = 2132975508, price = 150000, legality = "illegal", quantity = 1, weight = 45, stock = math.random(1, 4) },
      ...
      if weapon.type == "weapon" then
        ...
        if #weapons < MAX_PLAYER_WEAPON_SLOTS then
          ...
          if weapon.price <= user_money then -- see if user has enough money
            ...
            sv_storeItems["weapons"][index].stock = weapon.stock - 1
          else
