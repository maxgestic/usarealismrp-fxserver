...
AddEventHandler('veh:searchResult', function()
	...
	if math.random() > 0.6 then
		local money_found = math.random(10, 120)
...
TriggerEvent('es:addJobCommand', 'slimjim', { 'sasp', 'bcso', 'corrections' }, function(source, args, char)
	TriggerClientEvent('veh:slimjimVehInFrontPolice', source)
end, {
	help = "Slimjim the vehicle in front"
})

TriggerEvent('es:addJobCommand', 'hotwire', { 'sasp', 'bcso', 'corrections' }, function(source, args, char)
