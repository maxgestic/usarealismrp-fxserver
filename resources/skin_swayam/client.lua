...
RegisterNetEvent("CS:ShowMainMenu")
AddEventHandler("CS:ShowMainMenu", function()
...
RegisterNetEvent("CS:ShowPropsMenu")
AddEventHandler("CS:ShowPropsMenu", function()
...
Citizen.CreateThread(function()
	...
	while true do
		...
		if(menu == 1) then
			--Show main menu
			TriggerEvent("CS:ShowMainMenu")
			elseif(menu == 2) then
			--Show components menu
			TriggerEvent("CS:ShowComponentsMenu1")
			elseif(menu == 3) then
			--Show Props Menu
			TriggerEvent("CS:ShowComponentsMenu2")
			elseif(menu == 4) then
			--Show Props Menu
			TriggerEvent("CS:ShowPropsMenu")
		end
		Wait(0)
	end
	end)
