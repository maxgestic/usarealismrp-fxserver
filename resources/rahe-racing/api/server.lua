...
supportedVehicles = {
    ...
    { name = "Pegassi Ignus", model = "ignus", class = "S" },
    { name = "Dewbauchee Champion", model = "champion", class = "S" },
    ...
    { name = "Bravado Buffalo STX", model = "buffalo4", class = "B" },
    { name = "Enus Windsor Drop", model = "windsor2", class = "B" },
    { name = "Enus Jubilee", model = "jubilee", class = "B" },
    { name = "Enus Deity", model = "deity", class = "B" },
    ...
    { name = "Mammoth Patriot Mil-Spec", model = "patriot3", class = "C" },
