...
local RECOILS = {
	...
	[GetHashKey("WEAPON_MICROSMG")] = 1.4, -- MICRO SMG
	[GetHashKey("WEAPON_SMG")] = 1.3, -- SMG
	[GetHashKey("WEAPON_SMG_MK2")] = 1.3, -- SMG MK2
	[GetHashKey("WEAPON_ASSAULTSMG")] = 1.3, -- ASSAULT SMG
	[GetHashKey("WEAPON_ASSAULTRIFLE")] = 1.3, -- ASSAULT RIFLE
	[GetHashKey("WEAPON_ASSAULTRIFLE_MK2")] = 1.3, -- ASSAULT RIFLE MK2
	[GetHashKey("WEAPON_CARBINERIFLE")] = 1.3, -- CARBINE RIFLE
	[GetHashKey("WEAPON_CARBINERIFLE_MK2")] = 1.3, -- CARBINE RIFLE MK2
	[GetHashKey("WEAPON_ADVANCEDRIFLE")] = 1.4, -- ADVANCED RIFLE
	...
	[GetHashKey("WEAPON_VINTAGEPISTOL")] = 2.3, -- VINTAGE PISTOL
	[GetHashKey("WEAPON_DOUBLEACTION")] = 2.0, -- DOUBLE ACTION REVOLVER
	[GetHashKey("WEAPON_MUSKET")] = 2.0, -- MUSKET
	[GetHashKey("WEAPON_HEAVYSHOTGUN")] = 1.8, -- HEAVY SHOTGUN
	...
	[GetHashKey("WEAPON_COMPACTRIFLE")] = 1.7, -- COMPACT RIFLE
