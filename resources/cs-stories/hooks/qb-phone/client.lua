return function(resource)
    ...
    AddEventHandler('cs-stories:onStoryUpload', function(data)
        ...
        TriggerEvent('QBCore:Notify', 'Phone Stories: Your story has been uploaded!')
    end)

    AddEventHandler('cs-stories:onStoryUploadFailed', function(data)
        -- A story upload by this player failed.

        TriggerEvent('QBCore:Notify', 'Phone Stories: Your story upload failed, please try again!', 'error')
    end)
    ...
    AddEventHandler('cs-stories:onStoryDeleteOutcome', function(tempId, outcome)
        ...
        if (outcome == 'success') then
            TriggerEvent('QBCore:Notify', 'Phone Stories: You deleted story #' .. tempId .. '!')
        elseif (outcome == 'no_permissions') then
            TriggerEvent('QBCore:Notify', 'Phone Stories: You don\'t have permissions to delete story #' .. tempId .. '!', 'error')
