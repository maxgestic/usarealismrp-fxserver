return function(resource)
    ...
    CreateThread(function()
        CS_STORIES.SetKeyLabels(true) -- Setting this to true will label all the buttons with their respective keys.
        CS_STORIES.SetHandleRightClickAsBack(true) -- If your phone goes "back" when right clicking then set this to true, otherwise it should be false.
