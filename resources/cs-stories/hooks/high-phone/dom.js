const _CSS_notchOffset = '12.5%' // If your phone is using a skin with a notch you can specify the top distance it takes here.
...
window.CS_STORIES.hookInterface = () => {
    ...
    jQuery('.mainapps').append(_CSS_button)
