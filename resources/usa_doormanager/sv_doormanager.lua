...
local DOORS = {
  ...
  {name = "Mission Row / Roof", x = 463.58, y = -983.94, z =43.69, model = -340230128, locked = true, offset={0.0, -1.05, 0.10}, heading=89, _dist = 1.0, allowedJobs = {'sheriff', 'corrections', 'judge'}},
