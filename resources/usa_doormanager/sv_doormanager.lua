...
local DOORS = {
  ...
  --{name = "Boilingbroke Main Cell Block Area", x = 1787.12, y = 2890.83, z = 45.8, model = 430324891, gate = true, locked = true, offset={0.0, -1.13, 0.05}, lockedCoords={1786.61, 2590.03, 45.8}, _dist = 1.5, allowedJobs = {'sheriff', 'corrections', 'judge'}},
