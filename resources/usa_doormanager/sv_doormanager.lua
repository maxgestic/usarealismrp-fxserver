...
local DOORS = {
  ...
  {name = "Boilingbroke Main Cell Block Area", x = 1786.7034912109,y = 2590.3452148438, z = 45.797817230225, model = 430324891, locked = true, _dist = 2, gate = true, offset={0.65, -0.13, 1.05}, lockedCoords={1785.995, 2590.022, 44.793},  allowedJobs = {'sheriff', 'corrections', 'judge'}},
  {name = "Boilingbroke Lower Cell 1", x = 1786.35, y = 2586.55, z = 45.8, model = 430324891, locked = false, _dist = 2, gate = true, offset={0.0, 1.13, 1.05}, lockedCoords={1787.576, 2585.885, 44.794},  allowedJobs = {'sheriff', 'corrections', 'judge'}},
  {name = "Boilingbroke Lower Cell 2", x = 1786.44, y = 2582.59, z = 45.8, model = 430324891, locked = false, _dist = 2, gate = true, offset={0.0, 1.13, 1.05}, lockedCoords={1787.579, 2581.945, 44.795},  allowedJobs = {'sheriff', 'corrections', 'judge'}},
  {name = "Boilingbroke Lower Cell 3", x = 1786.95, y = 2578.53, z = 45.8, model = 430324891, locked = false, _dist = 2, gate = true, offset={0.0, 1.13, 1.05}, lockedCoords={1787.579, 2578.035, 44.795},  allowedJobs = {'sheriff', 'corrections', 'judge'}},
  {name = "Boilingbroke Lower Cell 4", x = 1787.09, y = 2574.81, z = 45.8, model = 430324891, locked = false, _dist = 2, gate = true, offset={0.0, 1.13, 1.05}, lockedCoords={1787.582, 2574.110, 44.795},  allowedJobs = {'sheriff', 'corrections', 'judge'}},
