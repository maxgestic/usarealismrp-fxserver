...
local DOORS = {
  ...
  -- Viceroy
  {name = "ViceroyStaffroom", x = -816.39, y = -1239.99, z = 7.49, model = 854291622, locked = true, offset={0.0, -1.0, 0.0}, heading=140, _dist = 1.5, allowedJobs = {'ems','doctor','sheriff','corrections'}},
  {name = "ViceroyReception", x = -811.52, y = -1239.32, z = 7.49, model = 854291622, locked = true, offset={0.0, -1.0, 0.0}, heading=230, _dist = 1.5, allowedJobs = {'ems','doctor','sheriff','corrections'}},
  {name = "ViceroyLab", x = -808.64, y = -1212.82, z = 7.49, model = 854291622, locked = true, offset={0.0, -1.0, 0.0}, heading=320, _dist = 1.5, allowedJobs = {'ems','doctor','sheriff','corrections'}},
  {name = "ViceroySurgery1L", x = -804.66, y = -1216.15, z = 7.49, model = -434783486, locked = true, offset={0.0, -1.0, 0.0}, heading=320, _dist = 1.5, allowedJobs = {'ems','doctor','sheriff','corrections'}},
  {name = "ViceroySurgery1R", x = -802.69, y = -1217.81, z = 7.49, model = -1700911976, locked = true, offset={0.0, -1.0, 0.0}, heading=320, _dist = 1.5, allowedJobs = {'ems','doctor','sheriff','corrections'}, static = true},
  {name = "ViceroySurgery2L", x = -799.9, y = -1220.15, z = 7.49, model = -434783486, locked = true, offset={0.0, -1.0, 0.0}, heading=320, _dist = 1.5, allowedJobs = {'ems','doctor','sheriff','corrections'}},
  {name = "ViceroySurgery2R", x = -797.93, y = -1221.8, z = 7.49, model = -1700911976, locked = true, offset={0.0, -1.0, 0.0}, heading=320, _dist = 1.5, allowedJobs = {'ems','doctor','sheriff','corrections'}, static = true},
  {name = "ViceroySurgery3L", x = -795.5, y = -1223.84, z = 7.49, model = -434783486, locked = true, offset={0.0, -1.0, 0.0}, heading=320, _dist = 1.5, allowedJobs = {'ems','doctor','sheriff','corrections'}},
  {name = "ViceroySurgery3R", x = -793.53, y = -1225.49, z = 7.49, model = -1700911976, locked = true, offset={0.0, -1.0, 0.0}, heading=320, _dist = 1.5, allowedJobs = {'ems','doctor','sheriff','corrections'}, static = true},
  {name = "ViceroyAdmin", x = -784.54, y = -1239.82, z = 7.49, model = 854291622, locked = true, offset={0.0, -1.0, 0.0}, heading=320, _dist = 1.5, allowedJobs = {'ems','doctor','sheriff','corrections'}},
  {name = "ViceroyX-Ray", x = -776.32, y = -1239.94, z = 7.49, model = 854291622, locked = true, offset={0.0, -1.0, 0.0}, heading=320, _dist = 1.5, allowedJobs = {'ems','doctor','sheriff','corrections'}},
  {name = "ViceroyDiagnostics", x = -781.2, y = -1235.84, z = 7.49, model = 854291622, locked = true, offset={0.0, -1.0, 0.0}, heading=320, _dist = 1.5, allowedJobs = {'ems','doctor','sheriff','corrections'}},
  {name = "ViceroyMRI", x = -784.97, y = -1232.68, z = 7.49, model = 854291622, locked = true, offset={0.0, -1.0, 0.0}, heading=320, _dist = 1.5, allowedJobs = {'ems','doctor','sheriff','corrections'}},
  ...
  {name = "SandyHospitalSurgery1L", x = 1828.59, y = 3686.16, z = 34.42, model = 1415151278, locked = true, offset={0.0, -1.0, 0.0}, heading=120, _dist = 1.5, allowedJobs = {'ems','doctor','sheriff','corrections'}},
  {name = "SandyHospitalSurgery1R", x = 1827.3, y = 3688.39, z = 34.42, model = 580361003, static = true, locked = true, offset={0.0, -1.0, 0.0}, heading=120, _dist = 1.5, allowedJobs = {'ems','doctor','sheriff','corrections'}},
  {name = "SandyHospitalSurgery1R", x = 1833.11, y = 3688.77, z = 34.42, model = 1415151278, locked = true, offset={0.0, -1.0, 0.0}, heading=120, _dist = 1.5, allowedJobs = {'ems','doctor','sheriff','corrections'}},
  {name = "SandyHospitalSurgery2L", x = 1831.82, y = 3691.0, z = 34.42, model = 580361003, static = true, locked = true, offset={0.0, -1.0, 0.0}, heading=120, _dist = 1.5, allowedJobs = {'ems','doctor','sheriff','corrections'}},
  {name = "SandyHospitalStaffBathroom", x = 1835.51, y = 3684.81, z = 34.3, model = -770740285, locked = true, offset={0.0, 1.0, 0.0}, heading=120, _dist = 1.5, allowedJobs = {'ems','doctor','sheriff','corrections'}},
  {name = "SandyHospitalStaffRommR", x = 1840.09, y = 3676.46, z = 34.42, model = 1415151278, locked = true, offset={0.0, -1.0, 0.0}, heading=120, _dist = 1.5, allowedJobs = {'ems','doctor','sheriff','corrections'}},
  {name = "SandyHospitalStaffRoomL", x = 1838.8, y = 3678.69, z = 34.42, model = 580361003, locked = true, offset={0.0, -1.0, 0.0}, heading=120, _dist = 1.5, allowedJobs = {'ems','doctor','sheriff','corrections'}, static = true},
  {name = "SandyHospitalReceptionLockerRoom", x = 1826.89, y = 3676.4, z = 34.3, model = -770740285, locked = true, offset={0.0, 1.0, 0.0}, heading=120, _dist = 1.5, allowedJobs = {'ems','doctor','sheriff','corrections'}},
  -- Townhall MLO
