...
local DOORS = {
  ...
  {name = "Bolingbroke Reception Visitors Access", x = 1835.528, y = 2587.44, z = 46.03712, model = -684929024, locked = true, offset={0.0, 1.13, 0.05}, heading=90.0, _dist = 1.5, allowedJobs = {'sheriff', 'corrections'}, denyOffDuty = true, prisonDoor = true},
  {name = "Bolingbroke Reception Prison Access", x = 1837.742, y = 2592.162, z = 46.03957, model = -684929024, locked = true, offset={0.0, 1.13, 0.05}, heading=0.0, _dist = 1.5, allowedJobs = {'sheriff', 'corrections'}, denyOffDuty = true, prisonDoor = true},
  {name = "Bolingbroke Reception Prison Access 2", x = 1831.34, y = 2594.992, z = 46.03791, model = -684929024, locked = true, offset={0.0, 1.13, 0.05}, heading=90.0, _dist = 1.5, allowedJobs = {'sheriff', 'corrections'}, denyOffDuty = true, prisonDoor = true},
  {name = "Bolingbroke Reception Photography Room", x = 1838.617, y = 2593.705, z = 46.03636, model = -684929024, locked = true, offset={0.0, 1.13, 0.05}, heading=270.0, _dist = 1.5, allowedJobs = {'sheriff', 'corrections'}, denyOffDuty = true, prisonDoor = true},
  {name = "Bolingbroke Reception Prisoner Visit Access", x = 1827.981, y = 2592.157, z = 46.03718, model = -684929024, locked = true, offset={0.0, 1.13, 0.05}, heading=180.0, _dist = 1.5, allowedJobs = {'sheriff', 'corrections'}, denyOffDuty = true, prisonDoor = true},
  {name = "Bolingbroke Reception Back Entrance", x = 1819.073, y = 2594.873, z = 46.08695, model = 1373390714, locked = true, offset={0.0, -1.00, 0.05}, heading=270.0, _dist = 1.5, allowedJobs = {'sheriff', 'corrections'}, denyOffDuty = true, prisonDoor = true},
  -- Prison Interior Fencing
  {name = "Bolingbroke Reception Exit Strip - Fence 1", x = 1796.9339599609, y = 2595.591796875, z = 45.796291351318, model = -1156020871, locked = true, offset={0.0, -1.5, -0.15}, heading=179.0, _dist = 1.5, allowedJobs = {'sheriff', 'corrections'}, denyOffDuty = true, prisonDoor = true},
  {name = "Bolingbroke Reception Exit Strip - Fence 2", x = 1797.1374511719, y = 2592.7006835938, z = 45.796291351318, model = -1156020871, locked = true, offset={0.0, -1.5, -0.15}, heading=179.0, _dist = 1.5, allowedJobs = {'sheriff', 'corrections'}, denyOffDuty = true, prisonDoor = true},
  {name = "Bolingbroke Yard - Fence 1", x = 1762.5541992188, y = 2529.7778320313, z = 45.56506729126, model = -1156020871, locked = true, offset={0.0, -1.5, -0.15}, heading=345.0, _dist = 1.5, allowedJobs = {'sheriff', 'corrections'}, denyOffDuty = true, prisonDoor = true},
  {name = "Bolingbroke Yard - Fence 2", x = 1727.8743896484, y = 2508.3688964844, z = 45.564826965332, model = -1156020871, locked = true, offset={0.0, -1.5, -0.15}, heading=75.0, _dist = 1.5, allowedJobs = {'sheriff', 'corrections'}, denyOffDuty = true, prisonDoor = true},
  {name = "Bolingbroke Yard - Fence 3", x = 1713.9183349609, y = 2489.5891113281, z = 45.564918518066, model = -1156020871, locked = true, offset={0.0, -1.5, -0.15}, heading=315.0, _dist = 1.5, allowedJobs = {'sheriff', 'corrections'}, denyOffDuty = true, prisonDoor = true},
  {name = "Bolingbroke Yard - Fence 4", x = 1672.8564453125, y = 2488.1877441406, z = 45.56494140625, model = -1156020871, locked = true, offset={0.0, -1.5, -0.15}, heading=225.0, _dist = 1.5, allowedJobs = {'sheriff', 'corrections'}, denyOffDuty = true, prisonDoor = true},
  {name = "Bolingbroke Yard - Fence 5", x = 1653.1295166016, y = 2492.6318359375, z = 45.564926147461, model = -1156020871, locked = true, offset={0.0, -1.5, -0.15}, heading=275.0, _dist = 1.5, allowedJobs = {'sheriff', 'corrections'}, denyOffDuty = true, prisonDoor = true},
  {name = "Bolingbroke Yard - Fence 6", x = 1622.3668212891, y = 2518.21484375, z = 45.564849853516, model = -1156020871, locked = true, offset={0.0, -1.5, -0.15}, heading=185.0, _dist = 1.5, allowedJobs = {'sheriff', 'corrections'}, denyOffDuty = true, prisonDoor = true},
  {name = "Bolingbroke Yard - Fence 7", x = 1618.0568847656, y = 2532.7873535156, z = 45.56481552124, model = -1156020871, locked = true, offset={0.0, -1.5, -0.15}, heading=225.0, _dist = 1.5, allowedJobs = {'sheriff', 'corrections'}, denyOffDuty = true, prisonDoor = true},
  {name = "Bolingbroke Yard - Fence 8", x = 1618.3316650391, y = 2574.7482910156, z = 45.564823150635, model = -1156020871, locked = true, offset={0.0, -1.5, -0.15}, heading=134.0, _dist = 1.5, allowedJobs = {'sheriff', 'corrections'}, denyOffDuty = true, prisonDoor = true},
  {name = "Bolingbroke Yard - Fence 9", x = 1681.9635009766, y = 2563.9404296875, z = 45.564853668213, model = -1156020871, locked = true, offset={0.0, -1.5, -0.15}, heading=270.0, _dist = 1.5, allowedJobs = {'sheriff', 'corrections'}, denyOffDuty = true, prisonDoor = true},
  {name = "Bolingbroke Yard - Fence 10", x = 1707.7094726563, y = 2563.8828125, z = 45.564849853516, model = -1156020871, locked = true, offset={0.0, -1.5, -0.15}, heading=269.0, _dist = 1.5, allowedJobs = {'sheriff', 'corrections'}, denyOffDuty = true, prisonDoor = true},
  {name = "Bolingbroke Yard - Fence 11", x = 1743.4985351563, y = 2561.7390136719, z = 45.565040588379, model = -1156020871, locked = true, offset={0.0, -1.5, -0.15}, heading=269.0, _dist = 1.5, allowedJobs = {'sheriff', 'corrections'}, denyOffDuty = true, prisonDoor = true},
  ...
  {name = "Bolingbroke Cellblock Security - Left", x = 1772.939, y = 2495.313, z = 49.84006, model = 241550507, locked = true, offset={0.0, 1.13, 0.05}, heading=30.0, _dist = 1.5, allowedJobs = {'sheriff', 'corrections', 'judge'}, denyOffDuty = true, prisonDoor = true},
  {name = "Bolingbroke Cellblock Security - Right", x = 1775.414, y = 2491.025, z = 49.84006, model = 241550507, locked = true, offset={0.0, 1.13, 0.05}, heading=30.0, _dist = 1.5, allowedJobs = {'sheriff', 'corrections', 'judge'}, denyOffDuty = true, prisonDoor = true},
  -- Medical Area
