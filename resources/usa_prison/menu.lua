...
local vehicles = {
  ...
  { name = "2018 Dodge Charger", hash = GetHashKey("p18charger") },
  { name = "2018 Ford F-250", hash = GetHashKey("p18f250") },
  { name = "2018 Ford Taurus", hash = GetHashKey("p18taurus") },
  { name = "2020 Ford Explorer", hash = GetHashKey("p20explorer") },
  { name = "2020 Chevorlet Tahoe", hash = GetHashKey("p20tahoe") },
  { name = "2021 Dodge Durango", hash = GetHashKey("p21durango") },
  { name = "2021 Chevorlet Tahoe", hash = GetHashKey("p21tahoe") },
  { name = "2022 GMC Sierra", hash = GetHashKey("p22sierra") },
  { name = "Ford F-350", hash = GetHashKey("sotruck") },
...
local PRISON_GUARD_SIGN_IN_LOCATIONS = {
    ...
    {x = 479.16693115234, y = -981.87713623047, z = 30.689672470093} -- MRPD
}
