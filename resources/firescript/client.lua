...
local randomFireLocations = { --  this is the format you need to put in for your possible locations.
	...
	{['x'] = 1198.59, ['y'] = 2701.14, ['z'] = 38.15}, -- route 68 clothing store, across from LSC
	{['x'] = 1309.51, ['y'] = 2646.405, ['z'] = 37.68}, -- route 68, field next to LSC
	{['x'] = 1992.22, ['y'] = 3040.71, ['z'] = 47.21}, -- yellow jack
	{['x'] = 1965.66, ['y'] = 3739.58, ['z'] = 32.31}, -- 24/7 sandy shores
	{['x'] = 1741.73, ['y'] = 3815.303, ['z'] = 34.709}, -- sandy shores house 1
	{['x'] = 1753.019, ['y'] = 3863.48, ['z'] = 34.519}, -- sandy shores house 2
	{['x'] = 1845.99, ['y'] = 3922.34, ['z'] = 33.11}, -- sandy shores house 3
	{['x'] = 1973.811, ['y'] = 3939.705, ['z'] = 32.67}, -- sandy shores wood structure 1
	{['x'] = 1394.485, ['y'] = 3598.94, ['z'] = 35.002}, -- sandy shores ace liquor
	{['x'] = 1538.56, ['y'] = 3698.93, ['z'] = 35.073}, -- sandy shores abandoned structure
	{['x'] = 442.388, ['y'] = 3560.12, ['z'] = 33.23}, -- sandy shores marina dr
	{['x'] = 16.45, ['y'] = 3732.76, ['z'] = 39.67}, -- sandy shores, stab city
	{['x'] = 2130.85,['y'] = 4776.05,['z'] = 40.44}, -- Grapeseed Airfield
	{['x'] = 574.15,['y'] = 5500.64,['z'] = 56.03}, -- Paleto Forest (Mount Chiliad)
	{['x'] = 1387.46, ['y'] = 618.46, ['z'] = 40.81}, -- Hen House
	{['x'] = 105.12, ['y'] = 6468.52, ['z'] = 31.62}, -- Blane County Savings Bank
	{['x'] = 101.50, ['y'] = 6921.32, ['z'] = 25.94}, -- Creepy House
	{['x'] = 1733.60, ['y'] = 6420.23, ['z'] = 35.03}, -- General Store (Paleto)
	{['x'] = 3316.78, ['y'] = 5171.57, ['z'] = 18.43}, -- El Gordo Drive House 1
	{['x'] = 505.72, ['y'] = 5283.33, ['z'] = 80.57} -- Lumber Yard
}
		...
		while true do 
			...
			if randomNumber > spawnRandomFireChance then
				...
				if chatStreetAlerts == true then
	            	--chatAlerts(x, y, z)
					send911Message("Civilian report of a fire / dark smoke.", location)
					Citizen.Wait(2000)
	        	end
...
AddEventHandler("lol:firethings", function()
    ...
    local firec = {}
        ...
        if chatStreetAlerts == true then
			--chatAlerts(x, y, z)	
			-- dispatch to police/ems/firedept:
			send911Message("Civilian report of a fire / smoke.")
		end
	--firehelper(fireremover)		
end)

function send911Message(msg, coords)
	-- send 911 message --
