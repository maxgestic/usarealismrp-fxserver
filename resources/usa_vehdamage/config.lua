...
Config = {
	...
	damageFactorPetrolTank = 6.0,				-- Sane values are 1 to 200. Higher values means more damage to vehicle. A good starting point is 64
	...
	cascadingFailureThreshold = 160.0,			-- Below this value, health cascading failure will set in
