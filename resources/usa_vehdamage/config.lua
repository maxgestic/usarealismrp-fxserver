...
Config = {
	...
	cascadingFailureSpeedFactor = 4.2,			-- Sane values are 1 to 100. When vehicle health drops below a certain point, cascading failure sets in, and the health drops rapidly until the vehicle dies. Higher values means faster failure. A good starting point is 8
	...
	limpModeMultiplier = 0.04,					-- The torque multiplier to use when vehicle is limping. Sane values are 0.05 to 0.25
