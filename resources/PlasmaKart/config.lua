...
SpikesKey = 22         -- The key to press to put spikes
BoostKey =	21		 -- The key to press to Boost
...
--Basic server
TenuFemme = {
[3] = {model = 265, color = 0}, 		-- Torso / Arms / Bras
[4] = {model = 105}, 	-- Legs / Pants / Jambe
[6] = {model = 79}, 	-- Feet / Shoes / Chaussure

[7] = {model = 0}, 		--Accessories / Accessoires
[8] = {model = 14}, 		--Undershirt / T-Shirt
[11] = {model = 0} 	--Tops / Veste

}

TenuHomme = {
[3] = {model = 243, color = 0},		-- Torso / Arms / Bras
[4] = {model = 100},    -- Legs / Pants / Jambe
[6] = {model = 81},     -- Feet / Shoes / Chaussure
