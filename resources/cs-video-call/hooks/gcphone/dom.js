...
if (window.APP.$phoneAPI.config && window.APP.$phoneAPI.config.Facetime)
    window.APP.$phoneAPI.config.Facetime = false

window.CS_VIDEO_CALL.hookInterface = () => {
    const screenEl = jQuery('.phone_screen').length > 0 ? jQuery('.phone_screen') : jQuery('.mainScreen')
