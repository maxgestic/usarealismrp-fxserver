...
local BLACKLISTED_ITEMS = {
	["male"] = {
		["components"] = {
			...
			[9] = {5, 7, 10, 11, 12, 14, 15, 18, 20, 21, 22, 23, 24, 26, 27, 30, 31, 32, 36, 37, 38, 41, 42, 43, 44, 45, 46, 47, 50}, -- vests
	...
	["female"] = {
		["components"] = {
			...
			[9] = {7, 8, 9, 11, 12, 14, 16, 17, 21, 31, 32, 33, 40, 41, 43, 44, 47, 49, 50, 51, 56},
