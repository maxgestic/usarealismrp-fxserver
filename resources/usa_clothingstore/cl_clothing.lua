...
local BLACKLISTED_ITEMS = {
	["male"] = {
		["components"] = {
			[7] = {1, 2, 3, 5, 6, 8, 16, 17, 24, 34, 35, 40, 61, 62, 63, 130, 131, 139, 140, 141, 142}, -- ties
			[8] = {16, 17, 22, 23, 24, 25, 26, 30, 32, 52, 57, 67, 70, 85, 86, 111, 128, 129, 130, 136, 144, 145}, -- torso 1
			[9] = {5, 7, 10, 11, 12, 14, 15, 18, 20, 21, 22, 23, 24, 30, 31, 32, 36, 37, 38, 41, 42, 43, 44, 45, 46, 47, 50}, -- vests
			[11] = {16, 24, 25, 26, 34, 35, 36, 37, 38, 39, 46, 47, 57, 58, 59, 61, 64, 78, 79, 82, 83, 86, 98, 102, 120, 121, 122, 124, 127, 128, 140, 141, 144, 145, 146, 147, 148, 149, 150, 158, 165, 170, 198, 199, 201, 203, 213, 230, 237, 247, 255, 296, 361, 362} -- torso 2
		},
		["props"] = {
	...
	["female"] = {
		["components"] = {
			...
			[8] = {9, 10, 16, 17, 18, 20, 22, 23, 24, 31, 43, 49, 67, 82, 83, 97, 121, 168, 176, 177},
			[9] = {7, 8, 9, 11, 12, 14, 16, 17, 31, 32, 33, 40, 41, 43, 44, 47, 49, 50, 51, 56},
			[11] = {16, 26, 34, 39, 40, 41, 42, 43, 55, 58, 59, 70, 71, 74, 78, 85, 91, 93, 100, 104, 108, 124, 144, 145, 148, 149, 150, 151, 152, 153, 154, 163, 179, 208, 209, 211, 213, 223, 228, 232, 239, 245, 252, 255, 262, 284, 306, 307, 317, 385, 386}
		},
		["props"] = {
