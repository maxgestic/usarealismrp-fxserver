...
local BLACKLISTED_ITEMS = {
	["male"] = {
		["components"] = {
			...
			[9] = {5, 7, 10, 11, 30, 31, 32, 36, 38, 45, 46, 47, 50}, -- vests
			[11] = {16, 24, 25, 26, 33, 47, 48, 51, 52, 55, 69, 90, 91, 93, 96, 97, 109, 110, 113, 114, 115, 116, 117, 118, 119, 127, 139, 168, 170, 172, 182, 199, 206, 216} -- torso 2
		},
		["props"] = {
