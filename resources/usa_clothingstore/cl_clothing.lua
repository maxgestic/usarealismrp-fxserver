...
local BLACKLISTED_ITEMS = {
	["male"] = {
		["components"] = {
			...
			[8] = {22, 23, 24, 25, 30, 32, 52, 57, 67, 81, 86, 111, 136, 145}, -- torso 1
			[9] = {5, 7, 10, 11, 14, 15, 30, 31, 32, 36, 38, 45, 46, 47, 50}, -- vests
			[11] = {16, 24, 25, 26, 45, 46, 49, 50, 51, 52, 54, 55, 56, 58, 59, 61, 65, 66, 67, 69, 70, 91, 94, 95, 107, 108, 111, 112, 113, 114, 115, 116, 117, 119, 120, 121, 122, 125, 137, 168, 170, 180, 197} -- torso 2
		},
		["props"] = {
	...
	["female"] = {
		["components"] = {
			...
			[8] = {9, 10, 18, 20, 22, 23, 24, 41, 44, 47, 65, 80, 81, 119, 175},
			[9] = {7, 8, 11, 12, 31, 32, 33, 40, 41, 44, 49, 50, 51, 56},
			[11] = {16, 26, 34, 35, 45, 47, 54, 62, 78, 87, 98, 99, 102, 103, 104, 105, 106, 107, 108, 117, 133, 165, 167, 182, 186, 193, 199, 238}
		},
		["props"] = {
			[1] = {8, 13, 17, 20, 42, 54}
		}
