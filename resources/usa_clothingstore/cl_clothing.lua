...
local BLACKLISTED_ITEMS = {
	["male"] = {
		["components"] = {
			[7] = {1, 2, 3, 5, 6, 8, 16, 17, 24, 34, 35, 40, 41, 77, 143, 144, 152, 153, 154, 161 164}, -- ties
			...
			[11] = {16, 24, 25, 34, 35, 36, 37, 38, 39, 46, 47, 57, 58, 59, 61, 100, 144, 182, 188, 189,} -- torso 2
		},
		["props"] = {
	...
	["female"] = {
		["components"] = {
			[7] = {1, 2, 3, 4, 5, 6, 8, 10, 11, 14, 23, 27, 28, 49, 58, 128},
			...
			[9] = {7, 8, 9, 11, 12, 14, 16, 17, 21, 22, 24, 31, 32, 33, 40, 41, 43, 44, 47, 49, 50, 51, 56},
			[11] = {16, 26, 34, 39, 40, 41, 42, 43, 55, 58, 59, 70, 71, 74, 116, 153, 189,}
		},
		["props"] = {
