...
local BLACKLISTED_ITEMS = {
	["male"] = {
		["components"] = {
			...
			[9] = {5, 7, 10, 11, 14, 15, 30, 31, 32, 36, 37, 38, 43, 45, 46, 47, 50}, -- vests
			[11] = {16, 24, 25, 26, 35, 36, 37, 38, 39, 41, 55, 56, 59, 60, 98, 99, 105, 117, 118, 123, 124, 125, 126, 127, 135, 142, 176, 180, 190, 207} -- torso 2
		},
		["props"] = {
	...
	["female"] = {
		["components"] = {
			...
			[11] = {16, 26, 34, 39, 40, 41, 42, 43, 46, 49, 53, 54, 59, 61, 68, 113, 118, 119, 122, 131, 177, 181, 191, 196, 207, 213}
		},
		["props"] = {
