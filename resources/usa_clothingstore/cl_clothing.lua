...
local BLACKLISTED_ITEMS = {
	["male"] = {
		["components"] = {
			[7] = {1, 2, 3, 5, 6, 8, 16, 17, 24, 34, 35, 40, 41, 46, 67, 68, 69, 136, 137, 145, 146, 148,}, -- ties
			...
			[11] = {16, 24, 25, 26, 34, 35, 36, 37, 38, 39, 46, 47, 57, 58, 59, 61, 72, 86, 87, 90, 91, 94, 110, 128, 129, 130, 132, 135, 136, 148, 149, 152, 153, 154, 155, 156, 157, 158, 166, 173, 178, 206, 207, 209, 211, 221, 238, 245, 248, 255, 263} -- torso 2
		},
		["props"] = {
	...
	["female"] = {
		["components"] = {
			...
			[9] = {7, 8, 9, 11, 12, 14, 16, 17, 31, 32, 33, 40, 41, 43, 44, 47, 49, 50, 51, 56},
