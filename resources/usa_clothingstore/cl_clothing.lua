...
local BLACKLISTED_ITEMS = {
	["components"] = {
		...
		[11] = {1, 17, 18, 19, 22, 24, 26, 29, 30, 31, 32, 34, 35, 36, 39, 40, 41, 47, 48, 51, 52, 64, 74, 75, 77, 80, 81, 93, 94, 97, 98, 100, 101, 102, 103, 111, 118, 123, 133, 143, 149, 150, 154, 155, 156, 183}, -- torso 2
		[7] = {1, 6, 8, 42, 119},
		[4] = {32}, -- Legs
