...
local ITEMS = {
  ["Drinks"] = {
      ...
      ["Corona Light Beer (4%)"] = {name = "Corona Light Beer (4%)", price = 10, type = "alcohol", substance = 15.0, quantity = 1, legality = "legal", weight = 10, strength = 0.01, caption = "A pale lager produced by Cervecería Modelo in Mexico"},
      ["Lagunitas IPA"] = {name = "Lagunitas IPA", price = 10, type = "alcohol", substance = 15.0, quantity = 1, legality = "legal", weight = 10, strength = 0.02, caption = "Big on the aroma with a hoppy-sweet finish that'll leave you wantin' another sip"},
      ["Budweiser"] = {name = "Budweiser", price = 10, type = "alcohol", substance = 15.0, quantity = 1, legality = "legal", weight = 10, strength = 0.02, caption = "An American-style pale lager produced by Anheuser-Busch"},
      ["Miller Lite"] = {name = "Miller Lite", price = 10, type = "alcohol", substance = 15.0, quantity = 1, legality = "legal", weight = 10, strength = 0.02, caption = "American light pale lager"},
      ["Grapefruit Sculpin"] = {name = "Grapefruit Sculpin", price = 10, type = "alcohol", substance = 15.0, quantity = 1, legality = "legal", weight = 10, strength = 0.02, caption = "Award-winning IPA, with a citrus twist"},
      ["Blue Moon"] = {name = "Blue Moon", price = 10, type = "alcohol", substance = 15.0, quantity = 1, legality = "legal", weight = 10, strength = 0.02, caption = "Belgian Style Wheat Ale"},
      ["Modelo Especial"] = {name = "Modelo Especial", price = 10, type = "alcohol", substance = 15.0, quantity = 1, legality = "legal", weight = 10, strength = 0.02, caption = "Crisp, clean, and refreshing. The model Mexican beer"},
      ["Jack & Coke"] = {name = "Jack & Coke", price = 30, type = "alcohol", substance = 15.0, quantity = 1, legality = "legal", weight = 10, strength = 0.08, caption = "Jack Daniel's whiskey and Coca-Cola served with ice"},
      ["Grey Goose Vodka"] = {name = "Grey Goose Vodka", price = 55, type = "alcohol", substance = 15.0, quantity = 1, legality = "legal", weight = 10, strength = 0.2, caption = "Grey Goose Vodka is distilled from French wheat and is made from spring water from Gensac that is naturally filtered through champagne limestone."},
