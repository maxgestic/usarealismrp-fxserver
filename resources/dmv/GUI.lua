...
function Menu.addButton(name, func,args)
	...
	Menu.GUI[Menu.buttonCount+1]["xmin"] = xmin + xoffset + 0.025
...
local xoffset = 0
		...
		DrawText((xoffset + 0.075), (yoffset - 0.05 - 0.0125 ))
		Menu.renderBox(xoffset,0.3,(yoffset - 0.05),0.05,20,30,10,255)
