...
AddEventHandler("globals:startActionMessage", function(msg, range, playerId)
    Citizen.CreateThread(function()
        ...
        if (Vdist(mycoords.x, mycoords.y, mycoords.z, coords.x, coords.y, coords.z) <= range and Vdist(mycoords.x, mycoords.y, mycoords.z, coords.x, coords.y, coords.z) > 0.0) or ped == myped then
