...
Config = {
    ...
    Vehicles = {
        ...
        hint = { -- Enable or disable the display of notifications in the top left corner when you are in a vehicle
            ...
            timeout = 6500 -- Time at which the hint will be displayed (0 = infinite)
        }, 
...
Config.Keys = {
    ...
    SpeakCarKey = 243, -- Key to speak in vehicle
    SpeakCarKeyString = '~INPUT_ENTER_CHEAT_CODE~', -- Key string to speak in vehicle
}
