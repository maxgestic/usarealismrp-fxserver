...
scramblerServerUser=minipunch1
...
sshpass -f "scramblerServerPass.txt" scp -r $scramblerServerUser@$scramblerServerIP:D:/fxserver-resource-scrambler-dist/scrambled_resources .
